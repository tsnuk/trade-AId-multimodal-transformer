...
class ProcessingPipeline:
    ...
    The pipeline processes data through a sequence of functions where each function
    receives the output of the previous function. Functions can be built-in or external,
    with arguments passed via the 'args' parameter. Execution is tracked and logged.
    """
    ...
    def _get_data_info(self, data: Any) -> str:
        ...
        Args:
            data: Data to get information about.
    ...
    def _track_special_processing(self, steps: List[ProcessingStep], metadata: Dict[str, Any]) -> None:
        ...
        Args:
            steps: List of processing steps to track.
